...
@section('content')
	<div class="container mb-4">
		<div class="text-center">
			...
			<p class="page-instructions">Select a franchise to view more details</p>
		</div>
		...
		<div class="row d-flex">		
			@foreach($franchises as $franchise)
				...
				@endphp
			<div class="col col-6 col-sm-4 col-md-3 col-lg-2 d-flex p-2 franchise-overview-card-column" data-name="{{ strtolower($franchise->name) }}">
				<a class="card w-100 franchise-overview-card" href="/franchise/{{ $franchise->id }}">
					<div class="card-header">{{ $franchise->name }}</div>
					<div class="card-body">

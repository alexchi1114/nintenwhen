	...
	<div class="container-fluid">
		<div class="row mb-4">
			<div class="col-12">
				...
				<div class="days-bar mb-2">
					...
					<div class="center" data-width="{{ $days_since_last_release / $max_days_between_releases }}" style="background-color:#{{$developer->primary_theme_color_hex}};"></div>
		...
		<div class="row mb-4">
			<div class="col-12">
				...
				<div class="days-bar">
					<div class="left" style="background-color:#{{$developer->primary_theme_color_hex}};"></div>
					<div class="center" data-width="{{ $avg_days_between_releases / $max_days_between_releases }}" style="background-color:#{{$developer->primary_theme_color_hex}};"></div>
					<div class="right" style="background-color:#{{$developer->primary_theme_color_hex}};"></div>
				</div>
			</div>
		</div>
			...
			<div class="row game-container align-items-center">
				<div class="col-12 col-md-4">
					...
					<div class="game-tag-container d-none d-md-block">
						<div class="game-tag" style="background-color:#{{ $developer->primary_theme_color_hex }}">
							{{ ucfirst($game->pivot->type) }}
						</div>
				...
				<div class="col-12 col-md-6 d-flex flex-column justify-content-center">
					...
					@if($i != sizeof($games) - 1)
						<div class="days-bar">
							<div class="left" style="background-color:#{{$developer->primary_theme_color_hex}};"></div>
							<div class="center" data-width="{{ $days_diff / $max_days_between_releases }}" style="background-color:#{{$developer->primary_theme_color_hex}};"></div>
							<div class="right" style="background-color:#{{$developer->primary_theme_color_hex}};"></div>
						</div>
					@endif
				</div>
